...
/**
 Setup a mapping from the host part of a URL to a view controller class, with no path paramaters
...
/**
 Setup a mapping from the host part of a URL to a view controller class, including path paramaters
 @param host the RFC1808 host of a URL to be mapped to a UIViewController subclass
 @param viewControllerClass The subclass of UIViewController to instantiate from URLs matching host
...
/**
 ...
 If the mapped view controller class implements willNavigateWithPathParamaters:queryParameters: it too will be called before returning. 
